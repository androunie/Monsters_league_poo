...
<html lang="fr">
    ...
    <body>
		...
		<!-- Cette page contient un formulaire, l'utilisateur doit remplir le formulaire avec les attributs de l'objet Monstre afin de l'ajouter à la bdd
			Ce formulaire une fois remplie ajoutera l'élement en appellant ma fonction créer dans le fichier 'addToBDD.php'
		 -->
		...
		<div class="inscription">
			<form method="POST" action="addToBDD.php">
				...
				<h2 class="text-center">Add a monster to the BDD</h2> <br />
